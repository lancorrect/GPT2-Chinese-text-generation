...
"""Three classes below belong to transformers.utils.generic"""
...
""""This function belongs to transformers.utils.generic"""
...
class SpecialTokensMixin:
    ...
    @bos_token.setter  # 定义好一个property后，可以使用setter来对其值进行设置
